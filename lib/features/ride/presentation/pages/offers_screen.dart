  ...
  Widget _buildOfferCard(BuildContext context, String name, String car, String price, String time, double rating, String imageUrl, {bool isBestPrice = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isBestPrice ? Border.all(color: AppTheme.secondaryColor.withOpacity(0.5), width: 2) : null,
                ...
                children: [
                  if (isBestPrice)
                    Container(
                      ...
                      child: const Text('أفضل سعر', style: TextStyle(color: AppTheme.secondaryColor, fontSize: 10, fontWeight: FontWeight.bold)),
                    ),
                  Text(price, style: const TextStyle(color: AppTheme.primaryColor, fontSize: 22, fontWeight: FontWeight.w900)),
                ],
              ),
            ],
          ),
                ...
                child: Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      borderRadius: BorderRadius.circular(15),
                      onTap: () {
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const MatchedScreen()));
                      },
                      child: const Padding(
